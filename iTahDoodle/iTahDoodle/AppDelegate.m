...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // A CRect is a struct with an origin (x, y) and a size (width, height)
    ...
    CGRect buttonFrame = CGRectMake(228, 40, 71, 31);
    ...
    // Create and configure teh UITextField instance where new tasks will be entered
    ...
    [self.window addSubview:_taskTable];
    [self.window addSubview:_taskField];
    [self.window addSubview:_insertButton];
//
//    [self.window.rootViewController addSubview:self.taskField];
